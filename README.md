...
|                                        Dashboard View                                        |                                        Add/Edit Item (Concept)                                |
| :------------------------------------------------------------------------------------------: | :-----------------------------------------------------------------------------------------: |
...
This application is currently run as a client-side interface using local component states. The client parses dynamic tasks using the following schema:
