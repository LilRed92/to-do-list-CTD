...
| :-------------------------------------------------------------------------------------------: | :-----------------------------------------------------------------------------------------: |
| <img src="./src/assets/DesktopView.png" alt="Desktop View" width="600" style="padding: 15px"> | <img width="200" alt="Mobile View" src="./src/assets/MobileView.png" style="padding: 45px"> |
